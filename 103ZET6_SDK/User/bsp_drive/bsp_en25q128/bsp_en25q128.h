...
#define	EN25QXX_CS_0 		GPIO_ResetBits ( GPIOB, GPIO_Pin_12 )   		//EN25QXX的片选信号
#define	EN25QXX_CS_1 		GPIO_SetBits ( GPIOB, GPIO_Pin_12 )  		//EN25QXX的片选信号
